...
let botaoTarefaRef = document.querySelector('#botaoTarefa')
let novaTarefaRef = document.querySelector('#novaTarefa')
let terminadasRef = document.querySelector('titulo-terminadas')
...
function logOutUser() {
  ...
  terminadasRef.addEventListener('click', () => {
      logOutUser()
  })
  ...
  function cadastrarTarefa(){
      ...
      fetch('https://ctd-todo-api.herokuapp.com/v1/tasks', requestTestando)
              .then(response => {
  ...
  botaoTarefaRef.addEventListener('click', event =>{
